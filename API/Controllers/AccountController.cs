    ...
    public class AccountController : BaseApiController
    {
        ...
        Register(RegisterDto registerDto)
        {
            if (await UserExists(registerDto.Username))
                return BadRequest("It seems someone got your username a few seconds ago, what a bad luck");
            ...
            var roleResult =
                await _userManager.AddToRoleAsync(user, "StrawHatPirate");
            ...
            return new UserDto {
                ...
                PhotoUrl = "assets/photos/default.png",
